...
* @returns {string}
*/
__exports.get_context = function(sheet_name, row_id, context_len, field_idx) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.get_context(retptr, ptr0, len0, row_id, context_len, field_idx);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_readAsArrayBuffer_fd0708047ef6aa7e = function() { return handleError(function (arg0, arg1) {
